...
const insert_experience = async(req, res) => {
        ...
        client.connect();
        await client.query('insert into experience (post,date_initial,date_ending,enterprise,description,actualy,id_user,shedule) values ($1, $2, $3, $4, $5,$6,$7,$8) returning *', [post,date_initial,date_ending,enterprise,description,actualy,id_user,shedule]).then(response=>{
...
const update_experience = async (req, res) => {
    ...
    const shedule=req.body.schedule;
        client.connect();
        await client.query('update experience set post=$1, date_ending=$2, date_initial=$3,enterprise=$4,description=$5,schedule=$6,actualy=$7 where id_experience=$8' ,[post, date_ending, date_initial,enterprise , description,shedule,actualy,id_experience]).then(response=>{
